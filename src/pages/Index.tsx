              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Подходит людям с чувствительностью к кофеину</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6">
            {[
              ...
              {
                icon: 'Users',
                text: 'Все кто скучают по ритуалу с кофе',
              },
              {
                icon: 'Zap',
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                icon: '🍯',
                title: 'Добавить',
                description: 'По желанию мёд или другой подсластитель',
              },
              {
                step: '04',
                icon: '☕',
